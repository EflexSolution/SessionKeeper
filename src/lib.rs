// src/lib.rs
/*
 * Core library for SessionKeeper
 */
...
#[derive(Debug)]
pub struct SessionKeeperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SessionKeeperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SessionKeeper processing");
    
    let mut processor = SessionKeeperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SessionKeeperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SessionKeeperProcessor::new(false);
